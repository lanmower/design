...
Generated 2026-08-20 by `node scripts/a11y-audit.mjs` against the live rendered DOM via axe-core, WCAG-tagged rules only: `wcag2a, wcag2aa, wcag21a, wcag21aa`.
...
24 kit(s) scanned, 0 blocking (serious/critical) node-level violation(s).
